...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Iniciar Sesión - Huella Digital</title>
        <meta name="description" content="Inicia sesión en tu cuenta de Huella Digital para continuar tu viaje de adopción." />
      </Helmet>
      <div className="min-h-screen bg-orange-50/50 flex flex-col justify-center items-center p-4">
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="tu@email.com" className="pl-9" value={email} onChange={(e) => setEmail(e.target.value)} disabled={loading} />
              </div>
            </div>
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" placeholder="········" className="pl-9" value={password} onChange={(e) => setPassword(e.target.value)} disabled={loading} />
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember-me" />
                <Label htmlFor="remember-me" className="text-sm font-normal text-gray-600">Recordarme</Label>
              </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ¿No tienes cuenta?{' '}
            <Link to="/registrarse" className="font-medium text-orange-600 hover:underline">
              Regístrate aquí
            </Link>
          </p>
        </motion.div>
